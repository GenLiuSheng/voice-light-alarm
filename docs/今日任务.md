...
- [ ] 预习 DS3231（0x68）、SSD1306（0x3C/0x3D）I2C 地址
...
### 今天完成
- [x] GitHub 仓库已建并 push（commit 558c6b4）
- [x] 硬件已购：ESP32-S3 N16R8 + 天宇 T21L 万用表（待到货）
