...
- Day 2 实际进度：Arduino IDE 已配置至可编译 `ESP32S3 Dev Module` 的空 Blink，VS Code 已下载；PlatformIO、工程学习和 M1 例程尚未开始。今日不确定引脚、不写 M1 例程，硬件状态待确认，未到货前不进行接线或实测（详见 [docs/Day2任务清单.md](docs/Day2任务清单.md)）
